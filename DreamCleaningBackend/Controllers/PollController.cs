    ...
    public class PollController : ControllerBase
    {
        ...
        public async Task<ActionResult> SubmitPoll(CreatePollSubmissionDto dto)
        {
            ...
            try
            {
                ...
                await SendPollSubmissionEmails(submission);
        ...
        private async Task SendPollSubmissionEmails(PollSubmission submission)
        {
            try
            {
                ...
                await _emailService.SendEmailAsync(companyEmail, subject, body);
                _logger.LogInformation($"Poll submission email sent for submission ID {submission.Id}");
            }
            catch (Exception ex)
            {
