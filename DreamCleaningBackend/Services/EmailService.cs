...
<body>
    ...
    ";
        ...
        public async Task SendAdditionalPaymentReminderEmailAsync(string email, string customerName, decimal additionalAmount, int orderId, string paymentLink)
        {
            try
            {
            ...
            <body>
                <div class='container'>
                    ...
                    <div class='content'>
                        <h2>Hi {customerName}!</h2>
                        <p>This is a gentle reminder that you have an unpaid amount for order #{orderId}. Whenever you're ready, you can complete the payment using the link below.</p>
                ...
                await SendEmailAsync(email, subject, body);
                _logger.LogInformation($"Additional payment reminder email sent to {email} for Order #{orderId}");
            }
            catch (Exception ex)
            {
